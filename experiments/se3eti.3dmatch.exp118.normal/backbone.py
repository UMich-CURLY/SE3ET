...
class E2PN(nn.Module):
    ...
    def forward(self, feats, data_dict):
        ...
        feats_s2_inv = self.equ2inv2(feats_s2, points_list[1], points_list[1], neighbors_list[1], normals_list[1])
        ...
        feats_s3_inv = self.equ2inv3(feats_s3, points_list[2], points_list[2], neighbors_list[2], normals_list[2])
        ...
        feats_s4_inv = self.equ2inv4(feats_s4, points_list[3], points_list[3], neighbors_list[3], normals_list[3])
