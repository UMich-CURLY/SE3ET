...
_C.output_dir = osp.join('/scratch/maanigj_root/maanigj0/chienerh/SE3ET/', 'output', _C.exp_name)
...
# data
_C.data = edict()
_C.data.dataset_root = osp.join('/scratch/maanigj_root/maanigj0/chienerh/SE3ET/', 'data', '3DMatch')
