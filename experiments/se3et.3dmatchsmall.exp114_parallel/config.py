...
# model - invariant GeoTransformer for point matching
...
# model - equivariant GeoTransformer for rotation supervision
_C.geotransformer2 = edict()
_C.geotransformer2.input_dim = 1024
_C.geotransformer2.hidden_dim = 256
_C.geotransformer2.output_dim = 256
_C.geotransformer2.num_heads = 4
# _C.geotransformer.blocks = ['self', 'cross', 'self', 'cross', 'self', 'cross']
_C.geotransformer2.blocks = ['self_eq', 'cross_a_soft', 'self_eq', 'cross_r_soft']
_C.geotransformer2.sigma_d = 0.2
_C.geotransformer2.sigma_a = 15
_C.geotransformer2.angle_k = 3
_C.geotransformer2.supervise_rotation = False
_C.geotransformer2.reduction_a = 'max'
_C.geotransformer2.align_mode = '0'
_C.geotransformer2.alternative_impl = False
_C.geotransformer2.n_level_equiv = 0
