...
class E2PN(nn.Module):
    ...
    def forward(self, feats, data_dict):
        ...
        # print('points_list[1]', points_list[1].shape)
        # print('points_list[2]', points_list[2].shape)
        # print('points_list[3]', points_list[3].shape)
        # print('neighbors_list[0]', neighbors_list[0].shape)
        # print('neighbors_list[1]', neighbors_list[1].shape)
        # print('neighbors_list[2]', neighbors_list[2].shape)
        # print('neighbors_list[3]', neighbors_list[3].shape)
        feats_s1 = feats
        feats_s1 = self.encoder1_1(feats_s1, points_list[0], points_list[0], neighbors_list[0])
        print('feats_s1 after encoder1_1', feats_s1.shape)
        feats_s1 = self.encoder1_2(feats_s1, points_list[0], points_list[0], neighbors_list[0])
        print('feats_s1 after encoder1_2', feats_s1.shape)

        feats_s2 = self.encoder2_1(feats_s1, points_list[1], points_list[0], subsampling_list[0])
        print('feats_s2 after encoder2_1', feats_s2.shape)
        feats_s2 = self.encoder2_2(feats_s2, points_list[1], points_list[1], neighbors_list[1])
        print('feats_s2 after encoder2_2', feats_s2.shape)
        feats_s2 = self.encoder2_3(feats_s2, points_list[1], points_list[1], neighbors_list[1])
        print('feats_s2 after encoder2_3', feats_s2.shape)
