...
from geotransformer.datasets.registration.threedmatch_toy.dataset import ThreeDMatchToySampleDataset
...
def train_valid_data_loader(cfg, distributed):
    train_dataset = ThreeDMatchToySampleDataset(
    ...
    valid_dataset = ThreeDMatchToySampleDataset(
        cfg.data.dataset_root,
        'val',
...
def test_data_loader(cfg, benchmark):
    ...
    test_dataset = ThreeDMatchToySampleDataset(
        cfg.data.dataset_root,
        benchmark,
        point_limit=cfg.test.point_limit,
        use_augmentation=False,
