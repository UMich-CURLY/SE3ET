...
class OverallLoss(nn.Module):
    ...
    def forward(self, output_dict, data_dict):
        if self.anchor_matching:
            coarse_loss, anchor_loss = self.coarse_anchor_loss(output_dict)
        else:
        ...
        if self.supervise_rotation:
            ...
            loss = self.weight_coarse_loss * coarse_loss + self.weight_anchor_loss * anchor_loss + self.weight_fine_loss * fine_loss
