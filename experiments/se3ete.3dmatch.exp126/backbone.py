...
from geotransformer.modules.e2pn.blocks_epn import LiftBlockEPN, SimpleBlockEPN, ResnetBottleneckBlockEPN, NormalWeightedInvOutBlockEPN
...
class E2PN(nn.Module):
    def __init__(self, input_dim, output_dim, init_dim, init_radius, init_sigma, group_norm, config_epn):
        ...
        self.equ2inv2 = NormalWeightedInvOutBlockEPN('inv_epn', init_dim * 4, config_epn)
        ...
        self.equ2inv3 = NormalWeightedInvOutBlockEPN('inv_epn', init_dim * 8, config_epn)
        ...
        self.equ2inv4 = NormalWeightedInvOutBlockEPN('inv_epn', init_dim * 16, config_epn)
        ...
        self.equ2inv = NormalWeightedInvOutBlockEPN('inv_epn', output_dim, config_epn)
