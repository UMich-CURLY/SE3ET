...
_C.train.point_limit = None # random select if number of points is larger than point_limit
_C.train.use_augmentation = False
_C.train.augmentation_noise = 0 # 0.005
_C.train.augmentation_rotation = 0 # 1.0
...
# model - Global
_C.model = edict()
_C.model.ground_truth_matching_radius = 0.01 # for toy dataset # 0.05 for original dataset
...
# _C.geotransformer.blocks = ['self_eq', 'cross_r_soft', 'self', 'cross']
...
_C.geotransformer.attn_r_positive = 'softplus' # 'sq', 'abs', 'sigmoid', 'leakyrelu', 'softplus', None
