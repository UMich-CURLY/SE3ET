...
from geotransformer.modules.e2pn.blocks_epn import LiftBlockEPN, SimpleBlockEPN, ResnetBottleneckBlockEPN, UnaryBlockEPN, LastUnaryBlockEPN, InvOutBlockEPN, NormalInvOutBlockEPN
...
class E2PN(nn.Module):
    def __init__(self, input_dim, output_dim, init_dim, init_radius, init_sigma, group_norm, config_epn):
        ...
        # self.equ2inv2 = NormalInvOutBlockEPN('inv_epn', init_dim * 4, config_epn)
        ...
        # self.equ2inv3 = NormalInvOutBlockEPN('inv_epn', init_dim * 8, config_epn)
        ...
        self.encoder4_3 = ResnetBottleneckBlockEPN('resnetb', init_dim * 16, init_dim * 16, init_radius * 8, init_sigma * 8, group_norm, config_epn)
        self.equ2inv4 = InvOutBlockEPN('inv_epn', init_dim * 16, config_epn)
        # self.equ2inv4 = NormalInvOutBlockEPN('inv_epn', init_dim * 16, config_epn)
        ...
        # self.equ2inv = NormalInvOutBlockEPN('inv_epn', output_dim, config_epn)
    ...
    def forward(self, feats, data_dict):
        ...
        normals_list = data_dict['normals']
...
class E2PN_normal(nn.Module):
    def __init__(self, input_dim, output_dim, init_dim, init_radius, init_sigma, group_norm, config_epn):
        super(E2PN_normal, self).__init__()
        self.preprocess = LiftBlockEPN('lift_epn', input_dim, config_epn)
        self.encoder1_1 = SimpleBlockEPN('simple', input_dim, init_dim, init_radius, init_sigma, group_norm, config_epn)
        self.encoder1_2 = ResnetBottleneckBlockEPN('resnetb', init_dim, init_dim * 2, init_radius, init_sigma, group_norm, config_epn) #resnetb_strided_epn?
    ...
    def forward(self, feats, data_dict):
        ...
        feats_s1 = feats # N x 1 
        feats_s1 = self.preprocess(feats_s1) # N x kanchor x 1
        feats_s1 = self.encoder1_1(feats_s1, normals_list[0], normals_list[0], neighbors_list[0]) # N x kanchor x init_dim
        feats_s1 = self.encoder1_2(feats_s1, normals_list[0], normals_list[0], neighbors_list[0]) # N x kanchor x init_dim*2

        feats_s2 = self.encoder2_1(feats_s1, normals_list[1], normals_list[0], subsampling_list[0]) # N' x kanchor x init_dim*2
        feats_s2 = self.encoder2_2(feats_s2, normals_list[1], normals_list[1], neighbors_list[1]) # N' x kanchor x init_dim*4
        feats_s2 = self.encoder2_3(feats_s2, normals_list[1], normals_list[1], neighbors_list[1]) # N' x kanchor x init_dim*4
        feats_s2_inv = self.equ2inv2(feats_s2, normals_list[1], normals_list[1], neighbors_list[1])

        feats_s3 = self.encoder3_1(feats_s2, normals_list[2], normals_list[1], subsampling_list[1])
        feats_s3 = self.encoder3_2(feats_s3, normals_list[2], normals_list[2], neighbors_list[2])
        feats_s3 = self.encoder3_3(feats_s3, normals_list[2], normals_list[2], neighbors_list[2]) # N'' x kanchor x init_dim*8
        feats_s3_inv = self.equ2inv3(feats_s3, normals_list[2], normals_list[2], neighbors_list[2])

        feats_s4 = self.encoder4_1(feats_s3, normals_list[3], normals_list[2], subsampling_list[2])
        feats_s4 = self.encoder4_2(feats_s4, normals_list[3], normals_list[3], neighbors_list[3])
        feats_s4 = self.encoder4_3(feats_s4, normals_list[3], normals_list[3], neighbors_list[3]) # N''' x kanchor x init_dim*16
        feats_s4_inv = self.equ2inv4(feats_s4, normals_list[3], normals_list[3], neighbors_list[3])
