...
from geotransformer.modules.e2pn.blocks import SimpleBlock, ResnetBottleneckBlock
from geotransformer.modules.kpconv import ConvBlock, ResidualBlock, UnaryBlock, LastUnaryBlock, UnaryBlock, LastUnaryBlock, nearest_upsample
...
class E2PN(nn.Module):
    def __init__(self, input_dim, output_dim, init_dim, init_radius, init_sigma, group_norm, config_epn):
        ...
        self.encoder1_1 = SimpleBlock('simple', input_dim, init_dim, init_radius, init_sigma, config_epn)
        self.encoder1_2 = ResnetBottleneckBlock('resnetb', init_dim, init_dim * 2, init_radius, init_sigma, config_epn) #resnetb_strided_epn?

        self.encoder2_1 = ResnetBottleneckBlock('resnetb_strided', init_dim * 2, init_dim * 2, init_radius, init_sigma, config_epn)
        self.encoder2_2 = ResnetBottleneckBlock('resnetb', init_dim * 2, init_dim * 4, init_radius * 2, init_sigma * 2, config_epn)
        self.encoder2_3 = ResnetBottleneckBlock('resnetb', init_dim * 4, init_dim * 4, init_radius * 2, init_sigma * 2, config_epn)

        self.encoder3_1 = ResnetBottleneckBlock('resnetb_strided', init_dim * 4, init_dim * 4, init_radius * 2, init_sigma * 2, config_epn)
        self.encoder3_2 = ResnetBottleneckBlock('resnetb', init_dim * 4, init_dim * 8, init_radius * 4, init_sigma * 4, config_epn)
        self.encoder3_3 = ResnetBottleneckBlock('resnetb', init_dim * 8, init_dim * 8, init_radius * 4, init_sigma * 4, config_epn)

        self.encoder4_1 = ResnetBottleneckBlock('resnetb_strided', init_dim * 8, init_dim * 8, init_radius * 4, init_sigma * 4, config_epn)
        self.encoder4_2 = ResnetBottleneckBlock('resnetb', init_dim * 8, init_dim * 16, init_radius * 8, init_sigma * 8, config_epn)
        self.encoder4_3 = ResnetBottleneckBlock('resnetb_epn', init_dim * 16, init_dim * 16, init_radius * 8, init_sigma * 8, config_epn)
